        ...
        buttonAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (intentData.length() > 0) {
                    scannedBarcode = new Bundle();
                    Fragment newFragment = new addProductFragment();
                    scannedBarcode.putString("params", intentData);
                    newFragment.setArguments(scannedBarcode);
...
/*
    ...
    protected void initialiseDetectorAndSources() {
        ...
        barcodeDetector.setProcessor(new Detector.Processor<Barcode>() {
            @Override
            public void release() {
                Toast.makeText(getApplicationContext(), "Scanner stopped due to inactivity", Toast.LENGTH_SHORT).show();
            }
